...
const th = {
  ...
  /* ============================================================
     หน้า /privacy — นโยบายความเป็นส่วนตัว + ข้อมูลที่เก็บ + ลบบัญชี ในหน้าเดียว
     สโตร์ (App Store / Google Play) บังคับให้มี URL สาธารณะสำหรับ "ขอลบบัญชี"
     ที่เปิดดูได้โดยไม่ต้องมีแอป — หน้านี้คือ URL นั้น

     ⚠ ข้อความในส่วน dataGroups/notCollected ตรวจกับ schema จริงมาแล้ว
     (db/migrations ฝั่ง su-server) อย่าเติมรายการที่ระบบไม่ได้เก็บจริง
     ============================================================ */
  privacy: {
    eyebrow: "ข้อมูลส่วนบุคคล",
    heading: "ความเป็นส่วนตัว",
    lead: "หน้านี้บอกว่าเราเก็บอะไรเกี่ยวกับคุณ เก็บไปทำไม ใครเห็นบ้าง และถ้าอยากลบบัญชีต้องทำอย่างไร",
...
const en: Dict = {
  ...
  privacy: {
    eyebrow: "Your data",
    heading: "Privacy",
    lead: "What we hold about you, why we hold it, who can see it, and how to delete your account.",
  ...
  step1: {
    ...
    errors: {
      ...
      phone: "Phone number must be 9 to 10 digits",
