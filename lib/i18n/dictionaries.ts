...
const th = {
  ...
  staffAuth: {
    ...
    register: {
      ...
      emailHint: "ใช้กู้รหัสผ่านเมื่อลืม · รับเฉพาะ @mfu.ac.th และ @lamduan.mfu.ac.th",
      password: "รหัสผ่าน",
      ...
      errEmail: "กรุณากรอกอีเมลมหาวิทยาลัย (@mfu.ac.th หรือ @lamduan.mfu.ac.th)",
  ...
  /** ลืมรหัสผ่าน (/auth/forgot, /auth/reset) — ใช้ร่วมกันทั้งผู้เข้าร่วมและเจ้าหน้าที่
      ตั๋วในลิงก์เป็นตัวบอกว่าเป็นบัญชีของใคร หน้าสองหน้านี้จึงไม่ต้องรู้ว่าใครเป็นบทบาทไหน */
  passwordReset: {
    eyebrow: "เดินรอบดอย 2569",
    /** ลิงก์บนหน้าเข้าสู่ระบบ */
    forgotLink: "ลืมรหัสผ่าน?",
    forgot: {
      heading: "ลืมรหัสผ่าน",
      sub: "กรอกชื่อผู้ใช้ แล้วเราจะส่งลิงก์ตั้งรหัสผ่านใหม่ไปที่อีเมลมหาวิทยาลัยที่ผูกกับบัญชี",
      username: "ชื่อผู้ใช้ หรือรหัสนักศึกษา",
      usernameHint: "ผู้เข้าร่วมใช้รหัสนักศึกษา 10 หลัก",
      submit: "ส่งลิงก์ตั้งรหัสผ่านใหม่",
      submitting: "กำลังส่ง…",
      errUsername: "กรุณากรอกชื่อผู้ใช้",
      failed: "ขอลิงก์ไม่สำเร็จ",
      sentHeading: "ส่งลิงก์แล้ว",
      /* ⚠ ข้อความต้องเป็น "ถ้ามีบัญชีนี้อยู่" ไม่ใช่ "ส่งแล้ว" — backend ตอบเหมือนกัน
         หมดไม่ว่าบัญชีจะมีจริงหรือไม่ (กันคนไล่เช็คว่ารหัสนักศึกษาไหนสมัครไว้บ้าง)
         ถ้าหน้าเว็บพูดว่า "ส่งแล้ว" ก็เท่ากับยืนยันการมีอยู่ของบัญชีแทน backend เอง */
      sentBody: "ถ้ามีบัญชีนี้อยู่จริง เราได้ส่งลิงก์ตั้งรหัสผ่านใหม่ไปที่อีเมลมหาวิทยาลัยที่ผูกกับบัญชีแล้ว",
      sentNote: "ลิงก์ใช้ได้ครั้งเดียว ภายใน 30 นาที · ถ้าไม่เห็นอีเมล ลองดูในโฟลเดอร์สแปม",
      staffNote:
        "เจ้าหน้าที่ที่สมัครไว้ก่อนระบบนี้เปิด อาจยังไม่มีอีเมลผูกกับบัญชี — กรณีนี้ต้องให้ผู้ดูแลตั้งรหัสผ่านใหม่ให้",
      backToLogin: "กลับไปหน้าเข้าสู่ระบบ",
    },
    reset: {
      heading: "ตั้งรหัสผ่านใหม่",
      sub: "ตั้งรหัสผ่านใหม่สำหรับบัญชีของคุณ",
      ...
      errPassword: "รหัสผ่านต้องยาวอย่างน้อย 8 ตัว",
      errConfirm: "รหัสผ่านไม่ตรงกัน",
      failed: "ตั้งรหัสผ่านใหม่ไม่สำเร็จ",
      missingToken: "ลิงก์ไม่สมบูรณ์ — กรุณาเปิดจากลิงก์ในอีเมลอีกครั้ง หรือขอลิงก์ใหม่",
      doneHeading: "ตั้งรหัสผ่านใหม่แล้ว",
      doneBody: "เข้าสู่ระบบด้วยรหัสผ่านใหม่ได้เลย",
...
const en: Dict = {
  ...
  staffAuth: {
    ...
    register: {
      ...
      emailHint: "Used to recover a forgotten password · only @mfu.ac.th and @lamduan.mfu.ac.th",
      password: "Password",
      ...
      errEmail: "Please enter a university email (@mfu.ac.th or @lamduan.mfu.ac.th)",
  ...
  passwordReset: {
    ...
    forgot: {
      ...
      sub: "Enter your username and we will email a reset link to the university address on your account.",
      username: "Username or student ID",
      usernameHint: "Participants use their 10-digit student ID",
      submit: "Email me a reset link",
      submitting: "Sending…",
      errUsername: "Please enter a username",
      failed: "Could not request a link",
      sentHeading: "Link sent",
      sentBody: "If that account exists, we have emailed a reset link to the university address on it.",
      sentNote: "The link works once, within 30 minutes. If it does not arrive, check your spam folder.",
      staffNote:
        "Staff who registered before this feature may not have an email on file yet — in that case an admin has to set the password for you.",
    ...
    reset: {
      ...
      errPassword: "Password must be at least 8 characters",
      errConfirm: "Passwords do not match",
      failed: "Could not set a new password",
      missingToken: "This link is incomplete — open it from the email again, or request a new one.",
